    ...
    <div className="py-4">
      ...
      <div className="flex flex-col items-center mb-12">
        ...
        >
          ...
          <button
            className={`py-3 px-6 md:px-8 rounded-full font-medium transition-all duration-300 relative z-10 flex-1 min-w-0 text-center ${
          ...
          <button
            className={`py-3 px-6 md:px-8 rounded-full font-medium transition-all duration-300 relative z-10 flex-1 min-w-0 text-center ${
              isYearly ? "text-white" : "text-foreground hover:text-[#10B981]"
            }`}
          ...
          >
            ...
            <div
              className={`absolute top-0 right-0 ${
                isYearly ? "bg-[#10B981]" : "bg-primary"
              } text-white px-4 py-2 text-sm font-medium rounded-bl-lg z-10 transition-colors duration-500`}
            >
            ...
            <div
              className={`absolute top-0 left-0 w-full h-full bg-gradient-to-b ${
                isYearly ? "from-[#10B981]/20" : "from-primary/20"
            ...
            <div className="p-8 flex-grow relative z-10">
              <div className="text-center mb-8">
                <div
                  ...
                  } px-4 py-1.5 rounded-full text-sm font-medium mb-4 transition-colors duration-500`}
                >
                ...
                <div className="flex items-center justify-center mb-2">
                  <span
                    className={`text-6xl font-bold ${
                      isYearly ? "text-[#10B981]" : "text-primary"
              ...
              <div
                className={`h-1 w-24 mx-auto ${
                  isYearly ? "bg-[#10B981]" : "bg-primary"
                } rounded-full mb-8 transition-colors duration-500`}
              ></div>

              <p className="text-foreground/80 mb-10 text-center text-lg max-w-2xl mx-auto">
                Get everything you need to create a high-converting landing page
            ...
            <div className="p-8 pt-0 relative z-10">
              <a
                ...
                className={`w-full block text-center rounded-lg py-4 px-6 font-medium text-white transition-all transform hover:scale-[1.02] ${
                  isYearly
                    ? "bg-[#10B981] hover:bg-[#10B981]/90 hover:shadow-[#10B981]/20"
                    : "bg-primary hover:bg-primary/90 hover:shadow-primary/20"
                } text-lg cursor-pointer shadow-lg hover:shadow-xl`}
              >
                Get Started Now
              </a>

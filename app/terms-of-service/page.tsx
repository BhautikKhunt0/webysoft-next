        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 mt-2">
              These Terms of Service ("Terms") govern your use of WebySoft's
              website and services. By using our services, you agree to these
              terms.
            </p>
          </motion.div>
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  By accessing or using WebySoft's website and services, you
            ...
            >
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  WebySoft provides professional web development and digital
                  solutions including:
                </p>
            ...
            >
              ...
              <div className="space-y-4 text-gray-300">
                <ul className="space-y-3">
                  ...
                  <li>
                    • Additional work beyond agreed scope may incur extra
                    charges
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  ...
                  <p>
                    ...
                    custom-developed websites and applications, excluding any
                    third-party components or our proprietary tools.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    We retain rights to our development methodologies,
                    proprietary tools, and general knowledge gained during
                    projects. We may showcase completed work in our portfolio
            ...
            >
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <ul className="space-y-2 ml-4">
                  ...
                  <li>
                    • Work completed to date will be delivered upon payment
                  </li>
                  <li>
            ...
            >
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  ...
                  will be resolved in the courts of Gujarat, India.
                </p>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="space-y-2">
                  <p>
                    <strong>Email:</strong> legal@webysoft.com
                  </p>
                  <p>

    ...
    <section id="how-it-works" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          >
            Our ISO-certified methodology ensures consistent delivery of
            enterprise-grade solutions with guaranteed security, scalability,
              ...
              >
                ...
                <div className={`space-y-6 ${isEven ? "" : "lg:col-start-2"}`}>
                  <div className="flex items-center gap-4">
                    <div
                      className={`text-6xl font-bold bg-gradient-to-r ${colors.gradient} bg-clip-text text-transparent opacity-50`}
                    >
                      {step.number}
                    </div>
                    <div
                ...
                <div className={`relative ${isEven ? "" : "lg:col-start-1"}`}>
                  <div className="bg-slate-800/30 backdrop-blur border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
                    <div className="space-y-6">
                      ...
                      <div
                        className={`h-64 rounded-xl ${colors.bg} ${colors.border} border flex items-center justify-center relative overflow-hidden`}
                      >
                        {/* Background Pattern */}
                        <div className="absolute inset-0 opacity-10">
                          <div className="grid grid-cols-4 h-full">
                            {[...Array(16)].map((_, i) => (
                              <div
                                key={i}
                                className={`border-r border-b ${colors.border}`}
                              />
                            ))}
                          </div>
                        </div>
                        ...
                        {/* Central Icon */}
                        <div
                          className={`relative z-10 p-6 rounded-full ${colors.bg} ${colors.border} border`}
                        >
                        ...
                        <motion.div
                          ...
                          className={`absolute top-4 right-4 w-3 h-3 rounded-full ${colors.text.replace(
                            "text-",
                            "bg-"
                          )}`}
                        />
                        <motion.div
                          ...
                          className={`absolute bottom-4 left-4 w-2 h-2 rounded-full ${colors.text.replace(
                            "text-",
                            "bg-"
                          )}`}
                        />
        ...
        >
          <div className="bg-slate-800/30 backdrop-blur border border-slate-700/50 rounded-2xl p-8">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Schedule a consultation with our certified experts to discuss your
              project requirements and receive a customized enterprise solution
              proposal.
            </p>
            <motion.button
